...
exports.humanFileSize = common_1.humanFileSize;
// nb: below are there only for use in the console:
exports.require = require;
exports.common = common;
async function main(p) {
    self = this;
    exports.log = new logger_1.default('gui', /*parent*/ null, /*onLineAdded*/ (name, date, args) => {
        const a = args.slice();
...
async function clickHelloWho() {
    ...
    try {
        ...
        exports.koHelloWho(`${exports.config.helloWho} !`);
    }
    catch (ex) {
        log.exception(ex);
    }
...
if (electron.app == null) {
    ...
    electron.app.once('ready', () => {
        exports.log = new logger_1.default('electron', /*parent*/ null, /*onLineAdded*/ (name, date, args) => {
            const a = args.slice();
            a.unshift(name + ':');
            console.log.apply(console, a);
        });
